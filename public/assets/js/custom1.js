(function($) {
    ...
    /*Light Horizontal End*/

    /*Color Horizontal Start*/
    ...
    /*Color Horizontal End*/

    /*Dark Horizontal Start*/
    $(document).on("click", '#myonoffswitch27', function() {
        if (this.checked) {
    ...
    /*Gradient Horizontal Start*/
    $(document).on("click", '#myonoffswitch28', function() {
        if (this.checked) {
